            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create-caso.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Adicionar Caso</a>
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Adicionar Advogado</a>
                        <form id="search-form">
