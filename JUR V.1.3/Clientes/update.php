...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($nome_err) && empty($sobrenome_err) && empty($cpf_err) ){
        ...
        $sql = "UPDATE cliente_adv SET nome=:nome, sobrenome=:sobrenome, cpf=:cpf WHERE id=:id";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                            <label>Nome</label>
                            <input type="text" name="nome" maxlength="100" class="form-control <?php echo (!empty($nome_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $nome; ?>">
